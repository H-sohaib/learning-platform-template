...
describe('API Endpoints', () => {
  test('GET /api/courses/:id should respond with 200 if course exists', async () => {
    const existingCourseId = 'existingCourseId'; // Replace with an actual existing course ID
  ...
  test('GET /api/courses/:id should respond with 404 if course does not exist', async () => {
    const nonExistingCourseId = 'nonExistingCourseId'; // Use a non-existing course ID
